...
from hubbub_codetest_project.users.forms import UserAdminChangeForm
...
from hubbub_codetest_project.users.views import UserRedirectView, UserUpdateView, user_detail_view
